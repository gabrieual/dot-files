...
async function toggleFavorite(recipeId) {
    try {
        ...
        if (!response.ok) {/home/gabrieu/Workstation/culinarIA/app/src/assets/favorite-filled.svg
        ...
        if (data.is_favorite) {
            ...
            favoriteBtn.querySelector('img').src = "app/src/assets/favorite-filled.svg";
        } else {
            favoriteBtn.classList.remove("text-orange-500");
            favoriteBtn.querySelector('img').src = "app/src/assets/favorite.svg";
        }
    } catch (error) {
        console.error('Erro:', error);
        alert(error.message);
