...
class User(UserMixin):
    ...
    def __init__(self, user_data=None):
        if user_data:
            ...
            self.favorites_recipes_id = user_data["favorites_recipes_id"]
    ...
    def add_favorite_recipe(self, recipe_id: int):
        ...
        if recipe_id not in self.favorites_recipes_id:
            ...
            # Atualiza a receita também
            from app.models.recipes import Recipe
            Recipe.add_to_favorites(recipe_id, self.id)
    ...
    def remove_favorite_recipe(self, recipe_id: int):
        ...
        if recipe_id in self.favorites_recipes_id:
            ...
            # Atualiza a receita também
            from app.models.recipes import Recipe
            Recipe.remove_from_favorites(recipe_id, self.id)

    def get_favorite_recipes(self):
        """Retorna todas as receitas favoritadas pelo usuário"""
        from app.models.recipes import Recipe
        return Recipe.get_user_favorites(self.id)
