...
def generate_message(context):
    ...
    , 'passos' (lista de instruções numeradas) e tags (lista que contém de pelo menos quatro tags que definam bem o receita, como 
    culinária, ingrediente principal ou qualquer outra informação desse tipo, tags em uppercase).
